            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $kategori->kategori_kode }}" type="text" name="kategori_kode" id="levelname" class="form-control" required>
                        <small id="error-levelname" class="error-text form-text text-danger"></small>
                    </div>

                    <div class="form-group">
                        <label>Kategori Nama</label>
                        <input value="{{ $kategori->kategori_nama }}" type="text" name="kategori_nama" id="name" class="form-control" required>
