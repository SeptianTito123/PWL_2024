            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $level->level_kode }}" type="text" name="level_kode" id="levelname" class="form-control" required>
                        <small id="error-levelname" class="error-text form-text text-danger"></small>
                    </div>

                    <div class="form-group">
                        <label>Level Nama</label>
                        <input value="{{ $level->level_nama }}" type="text" name="level_nama" id="name" class="form-control" required>
